...
//    }
    ...
    private void initView() {
        rl_back = (RelativeLayout) findViewById(R.id.rl_sale_back);
        rl_back.setOnClickListener(this);
        rl_classification = (RelativeLayout) findViewById(R.id.rl_fragment_sale_classification);
        rl_classification.setOnClickListener(this);
        rl_release = (RelativeLayout) findViewById(R.id.rl_fragment_sale_release);
        rl_release.setOnClickListener(this);
        imgFind = (ImageView) findViewById(R.id.img_find);
        imgFind.setOnClickListener(this);
        tv_typeName = (TextView) findViewById(R.id.tv_sale_type);
                    ...
                    public void onClick(View v) {
                        switch (v.getId()) {
                            case R.id.tv_find:
                                ...
                                keyWord = name;
                                Intent intent = new Intent(mContext, SaleFindActivity.class);
