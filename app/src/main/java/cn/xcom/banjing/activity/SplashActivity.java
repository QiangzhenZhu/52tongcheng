...
//            //是，则viewPager
    ...
    private void initViewPager() {
        ...
        viewPageAdapter = new ViewPageAdapter(list, views,mContext);
    ...
    private void initLoding(View view) {
        view.setBackgroundResource(R.mipmap.bg_defult);
