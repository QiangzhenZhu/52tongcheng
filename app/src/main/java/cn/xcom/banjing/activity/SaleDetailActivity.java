...
import cn.xcom.banjing.adapter.MyViewPageAdapter;
import cn.xcom.banjing.bean.Collection;
import cn.xcom.banjing.bean.ShopGoodInfoNew;
...
public class SaleDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void shareWX() {
        ...
        msg.title = ShareHelper.MarketShareTitle;
        msg.description = ShareHelper.MarketShareContent;
    ...
    private void toAlipay() {
        ...
        mediaMessage.title = ShareHelper.MarketShareTitle;
        mediaMessage.description = ShareHelper.MarketShareContent;
    ...
    private void shareToQQ() {
        ...
        params.putString(QQShare.SHARE_TO_QQ_SUMMARY, ShareHelper.MarketShareContent);
        ...
        params.putString(QQShare.SHARE_TO_QQ_APP_NAME, "52同城");
    ...
    private void shareToQzone() {
        ...
        params.putString(QzoneShare.SHARE_TO_QQ_TITLE, ShareHelper.MarketShareTitle);//必填
        params.putString(QzoneShare.SHARE_TO_QQ_SUMMARY, ShareHelper.MarketShareContent);//选填
