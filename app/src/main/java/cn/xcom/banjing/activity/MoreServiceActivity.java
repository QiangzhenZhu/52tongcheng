    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ll_more_service_training_course:
                ...
                intent.putExtra("url","http://banjing.xiaocool.net/index.php?g=portal&m=article&a=index&id=6");
                startActivity(intent);
                break;
            case R.id.ll_more_service_common_problem:
                intent = new Intent(mContext,WebViewActivity.class);
                intent.putExtra("title","常见问题");
                intent.putExtra("url","http://banjing.xiaocool.net/index.php?g=portal&m=article&a=index&id=5");
                startActivity(intent);
                break;
            case R.id.ll_more_service_legal_agreement:
                intent = new Intent(mContext,WebViewActivity.class);
                intent.putExtra("title","用户者服务协议");
                intent.putExtra("url","http://banjing.xiaocool.net/index.php?g=portal&m=article&a=index&id=4");
                startActivity(intent);
                break;
            ...
            case R.id.ll_about:
                intent = new Intent(mContext,WebViewActivity.class);
                intent.putExtra("title","关于52同城");
                intent.putExtra("url","http://banjing.xiaocool.net/index.php?g=portal&m=article&a=index&id=8");
                startActivity(intent);
                break;
