...
public class ShareQRCodeActivity extends BaseActivity {
    ...
    private void toAlipay() {
        ...
        mediaMessage.title = "我注册了52半径，来加入吧";
    ...
    private void shareToQQ() {
        ...
        params.putString(QQShare.SHARE_TO_QQ_TITLE, "我注册了52半径，来加入吧");
    ...
    private void shareToQzone() {
        ...
        params.putString(QzoneShare.SHARE_TO_QQ_TITLE, "我注册了52半径，来加入吧");//必填
