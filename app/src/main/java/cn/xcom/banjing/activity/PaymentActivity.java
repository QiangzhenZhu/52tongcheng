...
import cn.xcom.banjing.PayNew.OrderInfoUtil2_0;
import cn.xcom.banjing.PayNew.PayResult;
import cn.xcom.banjing.R;
import cn.xcom.banjing.WXpay.Constants;
import cn.xcom.banjing.WXpay.MD5;
import cn.xcom.banjing.WXpay.Util;
...
public class PaymentActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LinearLayout cardPay,weiXin;
    private CheckBox cb_zhifubao, cb_weixin ,cb_balance_pay;
     ...
     * 支付宝支付业务：入参app_id
     */
    public static final String APPID = "2017120400359615";
    // 商户私钥，pkcs8格式
    public static final String RSA_PRIVATE = "";
    private PayReq req;
    private String price, tradeNumber, tradeNo, body;
    private String type = ""; //1--任务,2--商品 3 便民圈支付 4我的发布支付 5 保证金支付
    private boolean tag;
...
//            }})
       /* StringPostRequest request = new StringPostRequest(url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                LogUtils.e("ABC","--2->"+volleyError.toString());
            }
        });*/
        if (type.equals("2")) {
            LogUtils.e("ABC","-3-->");
...
//        }
    ...
    private void checkPayType() {
        ...
        cb_balance_pay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cb_zhifubao.setChecked(false);
                cb_weixin.setChecked(false);
    ...
    private void initView() {
        ll_balance_pay = (LinearLayout) findViewById(R.id.balance_pay);
        ...
        cb_balance_pay = (CheckBox) findViewById(R.id.cb_payment_balance);
        //cb_yinhangka = (CheckBox) findViewById(R.id.cb_payment_yinhangka);
        //cardPay = (LinearLayout) findViewById(R.id.card_pay);
        weiXin=(LinearLayout) findViewById(R.id.weiXin_pay);
        bt_submit = (Button) findViewById(R.id.bt_payment_submit);
        bt_submit.setOnClickListener(this);
        bt_cancel = (Button) findViewById(R.id.bt_payment_cancel);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.bt_payment_submit:
                if (cb_zhifubao.isChecked()) {
                    HelperApplication.getInstance().wxpay = "1";
                    payV2();
                }
                if (cb_weixin.isChecked()) {
                    HelperApplication.getInstance().wxpay = "1";
...
//                            startActivity(new Intent(mContext, MyAdvertsingActivity.class));
                ...
                if (response != null) {
                    try {
                        ...
                        if (state.equals("success")) {
                            ...
                            String balanceMoney = jsonObject.getString("availablemoney");
                            if (Double.parseDouble(balanceMoney) >= Double.parseDouble(price)){
                                BalancePay();
                            }
                            else {
                                ToastUtil.showShort(PaymentActivity.this,"账户可用余额不足,无法完成支付");
                                hud.dismiss();
                                finish();
                            }
                        }
    ...
    private void BalancePay(){
        ...
        requestParams.put("money",price);
        requestParams.put("userid", userInfo.getUserId());
        HelperAsyncHttpClient.get(NetConstant.BALANCE_PAY, requestParams, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                super.onSuccess(statusCode, headers, response);
                LogUtils.e(TAG, "--statusCode->" + statusCode + "==>" + response.toString());
                if (response != null) {
                    try {
                        ...
                        if (state.equals("success")) {
                            hud.dismiss();
                            ToastUtil.showShort(PaymentActivity.this,"支付成功");
                            finish();
                        }
                        if (state.equals("error")){
                            hud.dismiss();
                            ToastUtil.showShort(PaymentActivity.this,response.getString("data"));
                            Log.d("balancePay", "onSuccess: "+response.getString("data")+response.getString("state"));
                            Log.d("balancePay", "onSuccess: "+tradeNo+"  "+price+ "  "+userInfo.getUserId());
                        }
                    } catch (JSONException e) {
                        hud.dismiss();
                        e.printStackTrace();
...
//            show.setText(sb.toString());
    ...
    private String genProductArgs() {
        ...
        try {
            ...
            packageParams.add(new BasicNameValuePair("notify_url", "http://banjing.xiaocool.net/api/returnwx/example/notify.php"));
...
//        show.setText(sb.toString());
    ...
    protected void onResume() {
        super.onResume();
        if (HelperApplication.getInstance().wxpay.equals("1")) {
