...
import cn.xcom.banjing.fragment.Authorized.BindAccountAuthorizedFragment;
import cn.xcom.banjing.fragment.Authorized.PhotoAuthorizedFragment;
...
public class AuthorizedActivity extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContext = this;
        initView();
        status =(String) SPUtils.get(this, HelperConstant.IS_HAD_AUTHENTICATION,"");
