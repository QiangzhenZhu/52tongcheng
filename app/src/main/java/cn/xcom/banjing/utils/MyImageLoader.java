...
public class MyImageLoader {
    private static DisplayImageOptions options=
            new DisplayImageOptions.Builder()
                    .showImageOnLoading(R.mipmap.bg_img_none)
                    .showImageOnFail(R.mipmap.bg_img_none)
                    .showImageForEmptyUri(R.mipmap.bg_img_none)
                    .cacheInMemory(true)
                    .cacheOnDisk(true)
    ...
    public static void displayBg(String uri,ImageView imageView){
//        ImageLoader.getInstance().displayImage(uri,imageView,options);
        ImageLoader.getInstance().displayImage(uri, new BgImageViewAware(imageView));
    }
